<%@ Page Title="Firefighter Display" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Firefighter_Display.aspx.cs" Inherits="WebApplication1.Admin.Firefighter.Firefighter_Display" %>
                ...
                <asp:GridView ID="FirefighterList" runat="server" AutoGenerateColumns="False" ShowFooter="True" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Update">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" ImageUrl="~/Images/edit_green.png" NavigateUrl='<%# Eval("Firefighter_ID", "~/Admin/Firefighter/Firefighter_Edit?Firefighter_ID={0}") %>' />
                            </ItemTemplate>
