    ...
    public partial class Dept_Add : System.Web.UI.Page
    {
                ...
                try
                {
                    if (Session["dept_id"] != null)
                    {
                        ...
                        if (editdepartment != null)
                        {
                            ...
                            CountyDD.SelectedValue = editdepartment.County_ID.ToString();
        ...
        protected void AddDept_Click(object sender, EventArgs e)
        {
            ...
            bool addSuccess = AddDept(AddDept_FDID.Text, AddDept_Name.Text,
                ...
                Convert.ToInt32(CountyDD.SelectedValue), AddDept_Callsign.Text);
            if (addSuccess)
            {
                // Reload the page.
                string pageUrl = Request.Url.AbsoluteUri.Substring(0, Request.Url.AbsoluteUri.Count() - Request.Url.Query.Count());
                //Response.Redirect(pageUrl + "?DepartmentAction=add");
                Response.Redirect("/Admin/Department/Dept_Display.aspx" + "?DepartmentAction=add");
            }
            else
            {
        ...
        protected void UpdateDept_Click(object sender, EventArgs e)
        {
            ...
            if (addSuccess)
            {
                ...
                Response.Redirect("/Admin/Department/Dept_Display.aspx" + "?DepartmentAction=update");
            }
            else
            {
        ...
        public List<HalonModels.County> GetCounties()
        {
            List<HalonModels.County> counties = _db.Counties.ToList();
            return counties;
        }
    }
}