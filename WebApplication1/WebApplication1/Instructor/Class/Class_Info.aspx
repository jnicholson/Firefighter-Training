<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Class_Info.aspx.cs" Inherits="WebApplication1.Instructor.Class.Class_Info" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    <section class="featured">
        <div class="content-wrapper">
            ...
            <section class="featured">
                <asp:GridView runat="server" ID="ClassTable" Width="800px"
