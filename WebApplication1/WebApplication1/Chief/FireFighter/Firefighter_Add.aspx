<%@ Page Title="Firefighter Add" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Firefighter_Add.aspx.cs" Inherits="WebApplication1.Chief.Firefighter.FirefighterAdd" %>
    ...
    <section class="featured">
        <div class="content-wrapper">
            <div id="FirefighterDetailsTitle" runat="server" class="ContentHead">
                ...
                <p>
                    <asp:Label ID="AddStatusLabel" runat="server" Text="" ForeColor="White" Font-Size="Larger" />
                </p>
                <p>
                    <asp:Button ID="AddAnotherFFButton" runat="server" Text="Add Another" OnClick="AddAnotherFFButton_Click" />
                </p>
            </div>
            <section class="featured">
                        ...
                        <tr class="ffLabel">
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="RFV2" ControlToValidate="LnameTB" runat="server" Display="dynamic"
                                    ErrorMessage="Enter a Last Name" ForeColor="Red">*</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr class="ffText">
                            <td>
            ...
            <asp:Button runat="server" ID="submitButton" Text="Submit" OnClick="AddFirefighter_Click" />
            <asp:Button runat="server" ID="cancelButton" Text="Cancel" OnClick="CancelAddFirefighter_Click" />
        </div>
    </section>
</asp:Content>
