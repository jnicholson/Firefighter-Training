<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dept_Add.aspx.cs" Inherits="WebApplication1.Chief.Department.Dept_Add" %>
            ...
            <section class="featured">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="AddDept_Count_ID" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="Validator8" runat="server" Text="* Department County ID required." ControlToValidate="AddDept_Count_ID" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
