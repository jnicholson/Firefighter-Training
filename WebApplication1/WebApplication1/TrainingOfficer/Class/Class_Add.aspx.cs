...
namespace WebApplication1.TrainingOfficer.Class
{
    public partial class Class_Add : System.Web.UI.Page
    {
        ...
        public void GetTeachers()
        {
            ...
            ffighters = ffighters.Where(f => f.Dept_ID == ffquery.FirstOrDefault().Dept_ID);
            ...
            {
                if (Roles.GetRolesForUser(f.Firefighter_Account_Username)[0] != "User" || Roles.GetRolesForUser(f.Firefighter_Account_Username)[0] != null)
                {
                    returnList.Add(f);
                }
            }
            ...
            query = query.OrderByDescending(f => f.Firefighter_Lname);
        ...
        protected void AddClassButton_Click(object sender, EventArgs e)
        {
            ...
            {
                // Reload the page.
                Response.Redirect("/TrainingOfficer/Class/Class_Display.aspx");
            }
        }
    }
}